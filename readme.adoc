...
* *Historical releases and spec versions* can be viewed on the versions overview page at https://{gh_org}.github.io/{gh_repo}/versions.html
...
A snapshot of the latest standalone CHERI HTML include non-frozen sections can be found here:
