...
[#rvy_topr_insn_table, reftext="{rvy_topr_insn_ext_name}"]
=== {rvy_topr_insn_ext_name}

{rvy_topr_insn_ext_name} adds the {GCTOP} instruction.

.{rvy_topr_insn_ext_name} instruction extension
[#{rvy_topr_insn_file_name}]
[width="100%",options=header,cols="2,5",]
|==============================================================================
include::{generated_dir}/{rvy_topr_insn_file_name}.adoc[]
|==============================================================================
