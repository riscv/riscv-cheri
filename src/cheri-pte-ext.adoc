...
there are circumstances where portions of general-purpose, mmaped memory become shared,
...
Page table enforcement can accellerate concurrant capability revocation
for temporal safety.
...
The CW bit indicates whether reading or writing capabilities with tag set to
