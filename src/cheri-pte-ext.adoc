[#section_sv_cheri]
== "Zcheri_pte" Extension for CHERI Page-Based Virtual-Memory Systems
...
instruction is executed, the authorising capability grants <<w_perm>> and
...
* When a capability store or AMO instruction is executed, the authorising
