...
If the base architecture is {cheri_base_ext_name}, then new instructions to update capability types are available.
Additionally, when XLEN=64, a new {sh4add_cheri} instruction and all matching `.uw` instructions are available.
