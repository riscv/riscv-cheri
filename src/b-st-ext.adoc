...
If the base architecture is {cheri_base_ext_name}, then the addresses which are incremented are capability types.
Therefore most Zba instructions are updated as shown.

Also see <<SH4ADD>>/<<SH4ADD_UW>>
