...
4+^| #{cheri_priv_s_ext} Supervisor YLEN-extended CSRs#
|`0x105` +
`0x140` +
`0x141`
|SRW +
...
4+^| #{cheri_priv_h_ext} Virtual Supervisor YLEN-extended CSRs#
|`0x205` +
`0x240` +
`0x241`
|HRW +
...
4+^|#{cheri_priv_m_ext} Machine YLEN-extended CSRs#
|`0x305` +
`0x340` +
`0x341`
|MRW +
...
4+^|#{cheri_priv_debug_ext} Debug Mode YLEN-extended CSRs#
|`0x7B1` +
`0x7B2` +
`0x7B3`
|DRW +
