...
{cheri_base_ext_name} remaps some of the 16-bit encoding space and so is incompatible with some Zc* ISA extensions.
...
. Specifying {cheri_base_ext_name} + C gives Zca and Zcb.
