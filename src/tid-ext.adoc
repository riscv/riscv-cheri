...
identify the current thread in the machine mode. The reset value of this
...
identify the current thread in the supervisor mode. The reset value of
...
identify the current thread in the user mode. The reset value of
this register is UNSPECIFIED.
...
It is used to identify the current thread in the machine mode.
...
It is used to identify the current thread in the supervisor mode.
...
It is used to identify the current thread in the user mode.
