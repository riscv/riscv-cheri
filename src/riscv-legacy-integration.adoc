...
When CRE=0, CHERI register and instruction access is prohibited for M-mode and lower privilege levels as described in xref:CRE[xrefstyle=short].
...
described in xref:CRE[xrefstyle=short].  CRE is read-only
