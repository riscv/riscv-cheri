...
. in debug mode <<CSRR>> of <<dfinc>> followed by <<GCTAG>> will return 1 for pass:attributes,quotes[{cheri_cap_mode_name}] and 0 for pass:attributes,quotes[{cheri_int_mode_name}]
