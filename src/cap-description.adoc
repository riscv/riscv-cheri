...
| 0b00001   | ✔ |   |   |   |     |      | Data RO
| 0b00010   | ✔ | ✔ | ✔ | ✔ |  ✔  |  Leg | Almighty (reset)
| 0b00011   | ✔ | ✔ | ✔ | ✔ |  ✔  | Pure | Almighty (purecap)
| 0b00100   |   | ✔ |   |   |     |      | Data WO
| 0b00101   7+| reserved
| 0b00110   | ✔ | ✔ |   |   |     |      | Data RW
| 0b00111   7+| reserved
| 0b01000   | ✔ | ✔ | ✔ | ✔ |  ✔  |  Leg | Execute + ASR
| 0b01001   | ✔ | ✔ | ✔ | ✔ |  ✔  | Pure | Execute + ASR
...
* <<c_perm>>: P[4] OR (P[3] AND P[1:0] != 0b11) OR (P[4:1] == 0b0001)
* <<w_perm>>: P[2] OR (P[4:1] == 0b0001) OR (P[3] AND P[2:1] != 0b01)
* <<r_perm>>: (P[4:0] != 0b00000) AND (P[4:0] != 0b00100)
* <<x_perm>>: (P[4:3] == 0b01) OR (P[4:1] == 0b0001)
* <<asr_perm>>: (P[3:1] == 0b100) OR (P[4:1] == 0b0001)
