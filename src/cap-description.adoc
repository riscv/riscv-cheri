...
implementation supports {cheri_hybrid_ext_name}, otherwise the bit is reserved
...
NOTE: The AP fields both set Hybrid Mode (if {cheri_hybrid_ext_name} is supported)
