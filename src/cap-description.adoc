...
NOTE: While XLENMAX=32 currently uses the same number of bits for permission encondings, it also includes the mode bit of {cheri_legacy_ext_name} which is separate for XLENMAX=64.

.Encoding of architectural permissions for XLENMAX=32
[#cap_perms_encoding32,width="60%",options=header,cols="^2,^1,^1,^1,^1,^1,^1,^1",align="center"]
|==============================================================================
| Encoding  | R | W | C | X | ASR | Mode | Notes
| 0b00000   |   |   |   |   |     |      | No permissions
| 0b00001   | ✔ |   |   |   |     |      | Data RO
| 0b00010   7+| reserved
| 0b00011   7+| reserved
| 0b00100   |   | ✔ |   |   |     |      | Data WO
...
| 0b00110   7+| reserved
| 0b00111   7+| reserved
| 0b01000   | ✔ | ✔ | ✔ | ✔ |  ✔  |  Leg | Execute + ASR (Almighty)
| 0b01001   | ✔ | ✔ | ✔ | ✔ |  ✔  | Pure | Execute + ASR (Almighty)
| 0b01010   | ✔ |   | ✔ | ✔ |     |  Leg | Execute + Cap RO
| 0b01011   | ✔ |   | ✔ | ✔ |     | Pure | Execute + Cap RO
| 0b01100   | ✔ | ✔ | ✔ | ✔ |     |  Leg | Execute + Cap RW
| 0b01101   | ✔ | ✔ | ✔ | ✔ |     | Pure | Execute + Cap RW
| 0b01110   | ✔ | ✔ |   | ✔ |     |  Leg | Execute + Data RW
| 0b01111   | ✔ | ✔ |   | ✔ |     | Pure | Execute + Data RW
| 0b10000   7+| reserved
| 0b10001   7+| reserved
| 0b10010   7+| reserved
| 0b10011   7+| reserved
...
capability to have these value since <<ACPERM>> will never create it. It is
possible for untagged capabilities to have it. <<GCPERM>> will interpret it
as if it were 0b00000 (no permissions). Future extensions may assign meaning to
the reserved bit patterns, in which case <<GCPERM>> is allowed to report a
non-zero value.
