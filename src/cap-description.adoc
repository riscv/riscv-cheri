...
The sealing bit conflates two concepts of the CHERI v9 ISA: Sealing data capabilities
with otypes and sealed entry (sentry) capabilities.
...
around. This architecture offers no way of unsealing a sealed data capability.
