...
NOTE: While XLENMAX=32 currently uses the same number of bits for permission encondings, it also includes the mode bit of {cheri_mode_ext_name} which is separate for XLENMAX=64.

.Encoding of architectural permissions for XLENMAX=32
[#cap_perms_encoding32,width="100%",options=header,cols="^2,^1,^1,^1,^1,^1,^1,^4",align="center"]
|==============================================================================
