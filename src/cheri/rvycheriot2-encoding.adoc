[#rv32y_cheriot2_cap_description, reftext="{rvy32_cheriot2_base_name} (CHERIoT V2a)"]
== The {rvy32_cheriot2_base_name} Capability Base Extension for {cheri_base32e_ext_name}, (CHERIoT V2a)

This chapter describes a variation on the <<rv32y_cheriot_cap_description>> encoding to support all exponents using the same number of bits.
...
The changes are limited to the bounds encoding; all other aspects of the capability encoding are identical to {rvy32_cheriot_base_name}.
...
.Capability encoding for {rvy32_cheriot2_base_name}
[#cap_encoding_cheriot2]
include::img/cap-encoding-cheriot2.edn[]

The only difference from <<rv32y_cheriot_cap_description>> is that the exponent field, E, is grown to 5 bits and the T field is shrunk to 8 bits.
...
.{rvy32_cheriot2_base_name} parameter summary
[#rvy32_cheriot2_base_name_param_summary,%autowidth,options=header,]
|==============================================================================
