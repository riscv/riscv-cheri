[#rv32y_cheriot2_cap_description, reftext="{rvy32e_cheriot2_base_name} (CHERIoT V2a)"]
== The {rvy32e_cheriot2_base_name} Capability Base Extension for {cheri_base32e_ext_name}, (CHERIoT V2a)
