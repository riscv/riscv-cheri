== {cheri_base_ext_name} Privileged and Debug ISA Summary
...
[#rvy_dret_insn_table, reftext="DRET for {cheri_base_ext_name}"]
=== DRET for {cheri_base_ext_name}

.DRET behavior for {cheri_base_ext_name}
[#rvy_dret_isa]
[width="100%",options=header,cols="2,5",]
|==============================================================================
include::{generated_dir}/RVY_DRET_insns_table_body.adoc[]
|==============================================================================
