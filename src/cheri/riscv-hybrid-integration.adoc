...
+
NOTE: It is recommended to authorize the prefetched address of <<PREFETCH_I_CHERI>> against <<pcc>> instead of <<ddc>>.
 ...
 Authorizing using <<ddc>> affects side-channels in {cheri_int_mode_name} only.
+
