...
// NOTE: The CHERI execution mode is effectively an extension to some RISC-V instruction encodings.
...
The CHERI execution mode is key in providing backwards compatibility with the base RV32I/RV64I ISA.
