...
| enableL8  | 1                    | Whether the encoding format includes the L8 bit
...
Compared to <<rvy64_cap_description,{rvy64_uni_base_name}>>, this encoding uses an additional `L8` bit as described in xref:section_cap_bounds[xrefstyle=short].
