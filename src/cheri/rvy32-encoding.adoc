...
Permissions added by extensions
ifndef::cheri_ratification_v1_only[]
(such as those of <<section_zylevels1>>)
endif::[]
are presumed absent in NULL capabilities.
...
are presumed present in infinite capabilities.
