...
==== AP encoding and rules without <<section_zylevels1,{cheri_levels1_ext_name}>> for {rv32y_uni_base_name}

.Encoding of architectural permissions for {rv32y_uni_base_name} without <<section_zylevels1,{cheri_levels1_ext_name}>>
...
.{rv32y_uni_base_name} <<CLRPERM>> rules if <<section_zylevels1,{cheri_levels1_ext_name}>> is absent.
...
==== AP encoding and rules with <<section_zylevels1,{cheri_levels1_ext_name}>> for {rv32y_uni_base_name}

.Encoding of architectural permissions for {rv32y_uni_base_name} with <<section_zylevels1,{cheri_levels1_ext_name}>>
...
.{rv32y_uni_base_name} <<CLRPERM>> rules if <<section_zylevels1,{cheri_levels1_ext_name}>> is present.
[float="center",align="center",cols="2,2,4",options="header"]
|===
| <<CLRPERM>> Rule | Permission            | Valid only if
