...
NOTE: AP[6:2] encodes R/W/C/LM permissions; AP[1] is <<asr_perm>>; AP[0] is <<x_perm>>.
...
6+| *Reserved for <<section_zylevels1>> (AP[6:4]=011 and 100)*
| 011xx 5+|  _reserved_ for <<section_zylevels1>>
| 100xx 5+|  _reserved_ for <<section_zylevels1>>
