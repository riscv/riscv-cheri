...
When {cheri_default_ext_name} is supported, capabilities include the <<p_bit>>. Otherwise, that field is _reserved_.
...
6+| *AP[4]=R, AP[3]=W, AP[2]=C (when AP[6:5]=00)*
| 00000 |   |   |   |    | *No permissions* (NULL capability)
| 00001 5+|  _reserved_ due to <<perm_req:base:c:r-or-w,base-1>>
| 00010 |   | W |   |    |
| 00011 |   | W | C |    |
| 00100 | R |   |   |    |
| 00101 | R |   | C |    |
| 00110 | R | W |   |    |
| 00111 | R | W | C |    |
6+| *LM=1 (AP[6:4]=001), AP[3]=W*
6+| *LM implies C and R*
| 01000 5+|  _reserved_ due to <<perm_req:base:lm:c-and-r,base-2>>
| 01001 | R |   | C | LM |
| 01010 5+|  _reserved_ due to <<perm_req:base:lm:c-and-r,base-2>>
| 01011 | R | W | C | LM | *Maximum base permissions*
6+| *Reserved for <<section_zylevels1>> (AP[6:5]=01 and 10)*
