...
Once all of the permission rules in <<base_clrperm_rule_summary>>, <<zylevels1_clrperm_table>> and <<zyhybrid_clrperm_table>> have been applied, the total valid combinations of permissions totals 180.
