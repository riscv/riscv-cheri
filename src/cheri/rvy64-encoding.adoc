...
| AP_PBit   | 0^1^                 | Whether the <<p_bit>> is encoded in the AP-field
| AP_MAX    | ones                 | Value of the AP field giving maximum permissions
|==============================================================================

^1^ This field is only defined if {cheri_default_ext_name} is implemented.
...
^1^ Only present if `AP_PBit=1` and {cheri_default_ext_name} is implemented.
