[#rv32y_cheriot2_cap_description, reftext="{rvy_cheriot_encoding2_suffix}"]
== The {rvy_cheriot_encoding2_suffix} CHERI Capability Encoding Scheme
...
The changes are limited to the bounds encoding; all other aspects of the capability encoding are identical to {rvy_cheriot_encoding_suffix}.
...
.Capability encoding for {rvy_cheriot_encoding2_suffix}
...
.{rvy_cheriot_encoding2_suffix} parameter summary
[#rvy_cheriot_encoding2_suffix_param_summary,%autowidth,options=header,]
|==============================================================================
