...
^3^ The compressed instructions to load and store capability data are unavailable as their encoding will revert to non-CHERI (see <<section_cheri_hybrid_ext>>).
