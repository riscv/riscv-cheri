...
The capability tag is set to zero on writing if:
...
| _CHERI Capability Tag_       | Load {ctag}      | Store {ctag}                        | Tagged memory supporting {ctag}s
| _CHERI Capability Tag Strip_ | Load zero {ctag} | Ignore stored {ctag}                | No support for {ctag}s, ignore them
| _CHERI Capability Tag Fault_ | Load zero {ctag} | Store/AMO Access Fault on {ctag}^1^ | No support for {ctag}s, trap on storing one
|=========================================================================================
...
Memory regions that do not have the _CHERI Capability Tag_ PMA do not require storage for {ctag}s.
