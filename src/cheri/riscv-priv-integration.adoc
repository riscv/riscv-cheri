...
The mtvec register is widened to an executable capability.
...
The *sepc* register is widened to an executable capability.
...
NOTE: The reset state enables the maximum number of extensions as CHERI and {cheri_int_mode_name} are both enabled.
