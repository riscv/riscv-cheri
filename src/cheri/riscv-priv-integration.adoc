...
[#section_rvy_vm]
=== Virtual Memory for {cheri_base_ext_name}
...
|=========================================================================================
| Bit                                 | Name       | Comment
| _pte_._{cheri_base_ext_name_lc}[3]_ | _pte_._ye_ | Enable capability (Y) access
| _pte_._{cheri_base_ext_name_lc}[2]_ | _reserved_ | Reserved
| _pte_._{cheri_base_ext_name_lc}[1]_ | _reserved_ | Reserved
| _pte_._{cheri_base_ext_name_lc}[0]_ | _reserved_ | Reserved
|=========================================================================================

If _pte_._ye_=0 then:
...
IMPORTANT: Any {cheri_base64_ext_name} hart that supports Sv39 must also implement the _pte.crw_ bit.
...
[%autowidth,float="center",align="center",cols="<,<,<",options="header"]
|===
|_pte.crw_|Instruction          | Behavior
| 0       |Capability store/AMO | Raise a _{cheri_excep_name_pte_st}_ if the to-be-stored {ctag} is set
| 0       |Capability load/AMO  | Set loaded {ctag} to zero
