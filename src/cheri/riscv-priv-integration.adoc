...
| All loads                                      | {cheri_excep_cause_ld}     | {cheri_excep_name_ld} | `auth_cap` fail any <<section_cap_integrity,integrity>> checks.
...
| All stores, all atomics, all CBOs              | {cheri_excep_cause_st}     | {cheri_excep_name_st} | `auth_cap` fail any <<section_cap_integrity,integrity>> checks.
