...
|==============================================================================
| CHERI Cause Code              | Name                        | Description
| {cheri_excep_cause_tag}       | {cheri_excep_name_tag}      | {cheri_excep_desc_tag}
| {cheri_excep_cause_seal}      | {cheri_excep_name_seal}     | {cheri_excep_desc_seal}
| {cheri_excep_cause_perm}      | {cheri_excep_name_perm}     | {cheri_excep_desc_perm}
| {cheri_excep_cause_inv_addr}  | {cheri_excep_name_inv_addr} | {cheri_excep_desc_inv_addr}
| {cheri_excep_cause_bounds}    | {cheri_excep_name_bounds}   | {cheri_excep_desc_bounds}
| 5-15                          | Reserved                    |
|==============================================================================

CHERI violations have the following priority order:

. {cheri_excep_name_tag} (_Highest_)
. {cheri_excep_name_seal}
. {cheri_excep_name_perm}
. {cheri_excep_name_inv_addr}
. {cheri_excep_name_bounds} (_Lowest_)
...
xref:section_cap_encoding[xrefstyle=short]), then set A's valid tag to zero.
 This will cause a {cheri_excep_name_tag} when executing the target instruction.
