...
The {cheri_base_ext_name} field is reserved in the RV64 PTE formats (e.g. <<sv39pte>>) for use by {cheri_base64_ext_name} extensions.
If the field is all zeroes then:
