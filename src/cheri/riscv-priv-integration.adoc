[#section_priv_cheri]
== "Machine/Supervisor_level ISA ({cheri_base_ext_name}" Extensions, Version 1.0
...
* Instructions from {rvyi_xref} and {rvyi_default_xref} cause illegal instruction exceptions.
