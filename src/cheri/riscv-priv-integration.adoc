...
.Action taken on writing to YLEN-bit Machine-Mode CSRs
...
.YLEN-bit Machine-Mode CSRs storing code pointers or data pointers
[#CSR_exevectors_m]
...
.All {cheri_base_ext_name} YLEN-bit Supervisor-Mode CSRs.
...
.Action taken on writing to YLEN-bit Supervisor-Mode CSRs
...
.YLEN-bit Supervisor-Mode CSRs storing code pointers or data pointers
[#CSR_exevectors_s]
[width="100%",options=header,cols="1,1,1,1,1"]
|==============================================================================
