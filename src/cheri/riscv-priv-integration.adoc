...
.Action taken on writing to YLEN-bit and extended Machine-Mode CSRs
...
.Action taken on writing to YLEN-bit and extended Supervisor-Mode CSRs
...
To allow standard RVI/RVE code to run at privilege levels below Machine-mode the registers are initialized as follows:
