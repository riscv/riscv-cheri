...
| {cheri_excep_cause_tag}       | {cheri_excep_name_tag}
| {cheri_excep_cause_seal}      | {cheri_excep_name_seal}
| {cheri_excep_cause_perm}      | {cheri_excep_name_perm}
| {cheri_excep_cause_inv_addr}  | {cheri_excep_name_inv_addr}
| {cheri_excep_cause_bounds}    | {cheri_excep_name_bounds}
| 5-15                          | Reserved
|==============================================================================
