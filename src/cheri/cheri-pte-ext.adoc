...
NOTE: The enable bit is required to redefine the usage of the _pte_._{rv64y_pte4_field_name_lc}_ field.
 It is a separate extension and not part of the {cheri_base64_ext_name} Privileged ISA, to allow future extensions to specify an alternative uses for the _pte_._{rv64y_pte4_field_name_lc}_ field.
