...
#This section is currently WIP and not suitable for freeze, but remains part of the v1.0 ratificaation package#
...
or hardware _pte.cd_ update (_Svadu_)^1^
...
Because the state of _pte.cd=1_ and _pte.crw=0_ is _reserved:
