...
NOTE: Because the state of _pte.cd=1_ and _pte.crw=0_ is _reserved_, , it is possible for the update of _pte.cd_ to fail if another thread has cleared _pte.crw_.
