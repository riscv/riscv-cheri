...
This extension specifies use of the {rv64y_pte4_field_name} field from the PTE formats (e.g., see <<sv39pte>>).
...
NOTE: This is equivalent to the behavior of the _pte_._d_ bit except that _pte_._{pte_cap_dirty_name_lc}_ tracks stores of valid capabilities instead of _all_ stores.
