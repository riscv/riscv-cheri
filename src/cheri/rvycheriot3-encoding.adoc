[#rv32y_cheriot3_cap_description, reftext="{rvy32e_cheriot2_base_name} (CHERIoT V2B)"]
== The {rvy32e_cheriot2_base_name} Capability Base Extension for {cheri_base32e_ext_name}, (CHERIoT V2b)
...
.Capability encoding for {rvy32e_cheriot2_base_name} (Alternative Version))
[#cap_encoding_cheriot3]
include::img/cap-encoding-cheriot3.edn[]

The only difference from {rvy32e_cheriot2_base_name} is that the top field, T, is replaced by a length, L.
...
// Decode base (same as <<rvy32e_cheriot_base_name>>)
c_b = (A[e + 8 : e]) < B ? -1 : 0
...
All other aspects of the capability encoding are identical to {rvy32e_cheriot2_base_name}.

==== Capability Encoding Parameter Summary

The encoding parameters for this encoding are identical to {rvy32e_cheriot2_base_name}.

.{rvy32e_cheriot2_base_name} (Alternative Version) parameter summary
[#rvy32e_cheriot3_base_name_param_summary,%autowidth,options=header,]
|==============================================================================
