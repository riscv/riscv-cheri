An {cheri_base_ext_name} core supports _all_ instructions from RVI and adds new instructions for CHERI functionality.
...
These 16-bit instructions are supported by any {cheri_base_ext_name} core that includes the standard Zca extension.
