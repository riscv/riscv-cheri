...
For example a <<root-rx-cap>> as specified for <<mtvec_y>> is the maximum, the platform my reset this CSR to a smaller memory range, or to have fewer permissions.
