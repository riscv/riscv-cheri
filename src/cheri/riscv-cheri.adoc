...
* [[rv32]] *RV32I*: See Chapter _RV32I Base Integer Instruction Set_ of cite:[riscv-unpriv-spec].
* [[gprs]] *General purpose registers*: See Chapter _RV32I Base Integer Instruction Set_ of cite:[riscv-unpriv-spec].
* [[ldst]] *Load and Store Instructions*: See Chapter _RV32I Base Integer Instruction Set_ of cite:[riscv-unpriv-spec].
* [[int-comp-lui-aiupc]] *Integer Register-Immediate Instructions* See Chapter _RV32I Base Integer Instruction Set_ of cite:[riscv-unpriv-spec].
* [[ct-insns]] *Control Transfer Instructions* See Chapter _RV32I Base Integer Instruction Set_ of cite:[riscv-unpriv-spec].
* [[zba]] *Zba* See Chapter _"B" Extension for Bit Manipulation_ of cite:[riscv-unpriv-spec].
