...
A valid capability that violates those invariants (i.e., valid tag set but malformed or valid
tag set with any reserved bit set) can only possibly be caused by
