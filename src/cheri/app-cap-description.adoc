...
MXLEN without including the valid tag bit. The value of CLEN is always calculated
...
. Cause certain manipulation instructions like <<CADDI>> to always set the valid tag of the result to zero.
