...
* The CHERIoT encoding optimized for smaller devices: {rvy32_cheriot_base_name}.

// Can uncomment this once CHERIoTv2 format is included in this spec?
ifndef::cheri_ratification_v1_only[]
NOTE: RV32YE (16-register) implementations are recommended to use the {rvy32_cheriot_base_name} format.
endif::[]
