...
Each new base ISA also declares a capability encoding format.
...
NOTE: The privileged `mconfigptr` CSR is the only documented exception to the rule, the justification for this is <<mconfigptr,here>>.
