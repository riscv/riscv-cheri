...
+
When a WARL CSR is widened it is possible that writing a capability to it will be corrupted, as some address bits may be modified on writing.
Altering the written address may effect the bounds decoding.
...
+
WARL capability CSRs need not be capable of holding all possible invalid capability values.
