...
The CHERI base ISA name is extended with the capability encoding format in use, and each implementation only supports one.
...
** {rvy32_uni_base_name}
** {rvy32e_uni_base_name}
ifndef::cheri_ratification_v1_only[]
* For {cheri_base32_ext_name}E, the CHERIoT encoding covering 8MB of memory, optimized for smaller devices:
