...
* The CHERIoT encoding optimized for smaller devices: {rvy_cheriot_encoding_suffix}.

// Can uncomment this once CHERIoTv2 format is included in this spec?
ifndef::cheri_ratification_v1_only[]
NOTE: RV32YE (16-register) implementations are recommended to use the {rvy_cheriot_encoding_suffix} format.
endif::[]
