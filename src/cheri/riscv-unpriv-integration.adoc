...
trusted code. This can be ensured through making the capability a sentry.
Trusted code can access memory through this capability and use it for implementing secure
compartment switches, e.g., by implementing a trusted stack.
