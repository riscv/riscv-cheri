...
NOTE: Instruction encodings refer to capability registers when they use `cs1`,`cd`, etc. instead of `rs1`,`rd` (which refers the the XLEN-bit subset of the register in the {cheri_base_ext_name} base ISA).
