...
NOTE: Future extensions to {cheri_base_ext_name} are permitted to choose a different capability encoding but must include these fields and conform with this chapter.
