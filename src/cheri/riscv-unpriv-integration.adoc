...
NOTE: For non-{cheri_base_ext_name} bases, C.SRLI, C.SRAI and C.SLLI also have code points which are HINTs if _shamt_=0. +
32-bit arithmetic HINT instructions are unaffected by this rule as all have _rd_=`x0`.
