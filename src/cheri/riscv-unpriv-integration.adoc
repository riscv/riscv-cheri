...
the <<sec_cap_type>> values
with which capabilities granting <<x_perm>> may be sealed from those
with which capabilities not granting <<x_perm>> may be sealed.
(The <<app_cap_description>> does not avail itself of this option,
