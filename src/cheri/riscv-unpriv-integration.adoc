...
Using a single encoding for both is undesirable:
 ...
 . The compiler and/or programmer would have to execute another metadata clearing instruction after each ADD to ensure that capabilities don't leak capabilities.
