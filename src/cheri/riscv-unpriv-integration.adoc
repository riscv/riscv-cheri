...
NOTE: Using {SCADDR} to update the <<pcc>> address can cause the target <<pcc>> {ctag} to be set to zero which raises a _{cheri_excep_name_pc}_ on the target instruction.
