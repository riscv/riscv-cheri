...
| Unrestricted <<sentry_cap>>^1^| 1             | Immutable _unrestricted sentry_ type for both _forward-edge_ and _backward-edge_ transitions.
| Forward-edge  <<sentry_cap>>  | 1             | Immutable _sentry_ type for _forward-edge_ transitions.
| Backward-edge <<sentry_cap>>  | 1             | Immutable _sentry_ type for _backward-edge_ transitions.
|===
