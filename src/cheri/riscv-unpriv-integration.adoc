...
The currently ratified {cheri_base_ext_name} base extensions including capability encoding formats are listed below:
...
** <<rv64y_cap_description, {rv64y_uni_base_name}>>
** The above encoding format can also be used for {rvy64e_uni_base}
...
** <<rv32y_cap_description, {rv32y_uni_base_name}>>
...
NOTE: The {rv64y_uni_base_name} and {rv32y_uni_base_name} base extensions are closely modeled upon features from CHERI v9 cite:[cheri-v9-spec], and the bounds encoding scheme is based upon CHERI Concentrate cite:[woodruff2019cheri].
