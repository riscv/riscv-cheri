...
NOTE: #this text should move to a programmers guide#
...
* Any instruction which writes back an address (e.g., <<AUIPC_CHERI>>), writes a full capability register instead.
...
* RVC encodings C.ADDI16SPN, C.ADDI4SP and C.MV change behavior
