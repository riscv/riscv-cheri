...
Extensions that modify capability metadata must describe their metadata's state in Infinite capabilities.
...
NOTE: Future ISA extensions should respect these rules so that these bits do not need storing in the implementation.
