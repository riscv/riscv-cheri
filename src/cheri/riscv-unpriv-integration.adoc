...
* **Maximum exponent (e<N>)**: The encoded value of the exponent for a valid capability spanning the whole address space. For example, for {cheri_base64_ext_name} with {cap_rv64_mw_width} bits of mantissa this would be `e{cap_rv64_exp_max}`.
