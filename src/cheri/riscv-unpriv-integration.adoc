...
NOTE: The base `_L<encoding_parameters>` encoding format scheme is designed to simply more encoding formats optimized for specific applications to be added in the future.
