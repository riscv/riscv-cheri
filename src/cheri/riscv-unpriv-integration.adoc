...
CHERI implementations are required to choose a capability encoding format that defines certain properties of the ISA such as the bounds precision and permissions encoding.
The CHERI base ISA name is extended with the capability encoding format in use as a suffix.
The definition of all CHERI base ISAs includes sufficient details of a capability encoding format to give enough details to allow execution of all base ISA instructions.
