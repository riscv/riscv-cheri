...
For example, if software removes `LM` from a capability to a linked list, any pointers loaded through that capability will automatically lose their <<w_perm>>, preventing modification of the list content.
