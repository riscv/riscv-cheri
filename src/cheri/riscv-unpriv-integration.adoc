...
{cheri_base_ext_name} has two classes of CSRs:
...
* YLEN-bit CSRs added by {cheri_base_ext_name} which contain capabilities (e.g., <<utidc>>).
...
[width="100%",options=header,cols="3,3,2,3,3,5"]
|==============================================================================
...
.Action taken on writing to YLEN-bit U-mode CSRs
