...
==== Extended <<gprs,general purpose integer registers>>
These XLEN-wide registers (e.g. `sp`, `a0`) are all extended with another XLEN bits of capability metadata plus a validity tag bit.
