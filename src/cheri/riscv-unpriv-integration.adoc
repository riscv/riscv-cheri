...
. _Unseal_ the target <<pcc>> if it is _sealed_ as a _forward-edge_ <<sentry_cap>> (type `1` qualifies for this) and `{cs1}.address[0]` is zero and the I-immediate is zero.
