...
.CHERI capability encoding CSR (`__x__ycfg`) format
[#ycfg_csr_structure]
[bytefield]
----
...
(def boxes-per-row 32)
(draw-column-headers {:height 20 :font-size 18 :labels (reverse (concat ["0"] (repeat 6 "") ["8" "9"] (repeat 22 "") ["XLEN-1"]))})

(draw-box "Features" {:span 24})
(draw-box "Base Encoding" {:span 8})

(draw-box "MXLEN-8"  {:span 24 :borders {}})
(draw-box "8"        {:span 8 :borders {}})
----

The following values for `mycfg`, `sycfg`, and `uycfg` are defined:
