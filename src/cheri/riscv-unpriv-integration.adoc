...
For all encodings defined in this specification, the only legal value for `N` is 1 and therefore this parameter may be omitted (but vendors may define alternate formats).
