...
+
The permission stripping behavior _only_ applies to loaded capabilities being written into the destination register with their {ctag} set and that are not sealed.
