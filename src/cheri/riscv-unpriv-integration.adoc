...
* [[xlen_csrs, XLEN-bit CSRs]]XLEN-bit CSRs, which do not contain addresses
** e.g., _fcsr_ from the "F" extension
* [[extended_csrs, extended CSRs]]XLEN-bit CSRs extended to YLEN bits, which are able to contain addresses (referred to as _extended CSRs_)
** e.g., _jvt_ from the "Zcmt" extension
* [[ylen_csrs, YLEN-bit CSRs]]YLEN-bit CSRs, which are added by {cheri_base_ext_name} and contain addresses
** e.g., <<utidc>>
