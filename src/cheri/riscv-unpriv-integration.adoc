...
ifndef::cheri_ratification_v1_only[]
When using <<rv64y_cap_description,{rv64y_uni_base_name}>> and <<rv32y_cap_description,{rv32y_uni_base_name}>> the complete set of rules are shown in <<clrperm-rules>>.
endif::[]
