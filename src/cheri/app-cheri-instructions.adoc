...
Many mnemonics have been renamed since v0.9.5 of the specification as shown in <<ISA_renames_095>>.

.ISA renames since 0.9.5
[#ISA_renames_095]
[width="100%",options=header,cols="2,2,2",]
|==============================================================================
include::{generated_dir}/old_and_new_mnemonics_table_body.adoc[]
|==============================================================================
...
[width="100%",options=header,cols="2,2,2",]
|==============================================================================
include::{generated_dir}/new_instructions_table_body.adoc[]
|==============================================================================
...
. ACPERM was replaced by {CLRPERM}. The difference is that the mask is used to clear, not retain, permission bits.
...
. Capability encodings and extensions are now the naming authorities for capability types (only 0/unsealed exists in the base architecture).
