...
These instructions are not controlled by the {CRE} bits in <<misa>>, <<menvcfg>> or <<senvcfg>>.
...
An {cheri_base_ext_name} core imports all instructions from RV32I/RV64I as required.
{rvyi_mod_ext_name} is a mandatory extension which _modifies_ existing instructions for CHERI functionality.
