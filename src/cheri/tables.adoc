...
.{cheri_base_ext_name} new instructions
[#{rvy_file_name}]
...
[#rvy_c_insn_table, reftext="{rvy_c_ext_name}"]
=== {rvy_c_ext_name}

An {cheri_base_ext_name} core which supports Zca should also support {rvy_c_ext_name}.

{rvy_c_ext_name} is incompatible with Zcf (RV32) and Zcd (RV64).

.{rvy_c_ext_name} instruction extension
[#{rvy_c_file_name}]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvy_c_file_name}.adoc[]
|==============================================================================
...
[#rvy_c_mod_insn_table, reftext="{rvy_c_mod_ext_name}"]
=== {rvy_c_mod_ext_name}

An {cheri_base_ext_name} core which supports Zca must also support {rvy_c_mod_ext_name} which _modifies_ the behavior of some instructions.

NOTE: {C_MV_CAP_LC} is renamed from `c.mv` to avoid ambiguity in disassembly.

.{rvy_c_mod_ext_name} instruction extension
[#{rvy_c_mod_file_name}]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvy_c_mod_file_name}.adoc[]
|==============================================================================
...
Specifying {cheri_base_ext_name} and Zalrsc gives {rvy_zalrsc_ext_name} functionality, which adds atomic capability load and store instructions.
