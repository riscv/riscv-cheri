...
[#{lr_sc_bh_ext_name}_summary_table]
...
An {cheri_base_ext_name} core imports _all_ instructions from RV32I/RV64I.
{rvyi_ext_name} is a mandatory extension which adds new instructions for CHERI functionality.

.{rvyi_ext_name} instruction extension
[#{rvyi_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyi_ext_name}_insns_table_body.adoc[]
|==============================================================================

[#rvyi_sentry_ext_name, reftext="{rvyi_sentry_ext_name}"]
=== {rvyi_sentry_ext_name}

{rvyi_sentry_ext_name} is an optional extension.

.{rvyi_sentry_ext_name} instruction extension
[#{rvyi_sentry_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyi_sentry_ext_name}_insns_table_body.adoc[]
|==============================================================================

[#rvyi_mod_ext_name, reftext="{rvyi_mod_ext_name}"]
=== {rvyi_mod_ext_name}

An {cheri_base_ext_name} core imports all instructions from RV32I/RV64I as required.
{rvyi_mod_ext_name} is a list of instructions which are _modified_ by adding CHERI functionality.

.{rvyi_mod_ext_name} instruction extension
[#{rvyi_mod_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyi_mod_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
[#{rvyc_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyc_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
[#{rvyc_mod_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyc_mod_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
An {cheri_base_ext_name} core which supports Zalrsc must also support {rvyalrsc_ext_name}.

.{rvyalrsc_ext_name} instruction extension
[#{rvyalrsc_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyalrsc_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
An {cheri_base_ext_name} core which supports Zaamo must also support {rvyaamo_ext_name}.

.{rvyaamo_ext_name} instruction extension
[#{rvyaamo_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyaamo_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
An {cheri_base_ext_name} core which supports the "H" extension must also support {rvyh_ext_name}.
...
[#{rvyh_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyh_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
An {cheri_base_ext_name} core which supports Zba must also support {rvyba_ext_name}.

.{rvyba_ext_name} instruction extension
[#{rvyba_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyba_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
Zicbom for an {cheri_base_ext_name} core is replaced by {rvycbom_ext_name}.

.{rvycbom_ext_name} instruction extension
[#{rvycbom_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvycbom_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
Zicboz for an {cheri_base_ext_name} core is replaced by {rvycboz_ext_name}.

.{rvycboz_ext_name} instruction extension
[#{rvycboz_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvycboz_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
Zicbop for an {cheri_base_ext_name} core is replaced by {rvycbop_ext_name}.

.{rvycbop_ext_name} instruction extension
[#{rvycbop_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvycbop_ext_name}_insns_table_body.adoc[]
|==============================================================================
...
An {cheri_base_ext_name} core which supports {rvyi_default_ext_name} adds the instructions in <<{rvyi_default_ext_name}_summary_table>>.

.{rvyi_default_ext_name} instruction extension
[#{rvyi_default_ext_name}_summary_table]
[width="100%",options=header,cols="3,1,1,1,4"]
|==============================================================================
include::generated/{rvyi_default_ext_name}_insns_table_body.adoc[]
|==============================================================================
