...
=== An RV32{rvy_cheriot_common_base_suffix} Common Base Architecture
...
NOTE: This parameter list needs to be updated.
...
- `pc`: The set of capability permissions that can be expressed is subject to
