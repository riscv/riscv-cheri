...
:cheri_int_mode_name: pass:quotes[_RVI Pointer Mode_]
:cheri_cap_mode_name: pass:quotes[_RVY Pointer Mode_]
...
// Base suffixes
:rv32y_uni_encoding_suffix: LYmw{cap_rv32_mw_width}rc1pc
:rv64y_uni_encoding_suffix: LYmw{cap_rv64_mw_width}rc1ps
