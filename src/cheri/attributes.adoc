...
:not_v1_ratification_package_freeze:       pass:quotes[#This chapter is not part of the v1.0 ratification package and is ready to freeze.#]
:not_v1_ratification_package_stable:       pass:quotes[#This chapter is not part of the v1.0 ratification package and is stable.#]
:not_v1_ratification_package_experimental: pass:quotes[#This chapter is not part of the v1.0 ratification package and is experimental.#]
...
:cheri_base_ext_name_lc:   pass:quotes[rvy]
// CHERI extension adding support for integer pointer mode (and mode bit)
:cheri_default_ext_name:   Zyhybrid
:cheri_default_sext_name:  Syshybrid
:cheri_default_mext_name:  Symhybrid
:cheri_mode_name:          CHERI Pointer Mode
:cheri_priv_m_ext: Machine-Level ISA ({cheri_base_ext_name})
:cheri_priv_m_reg_enable_ext: {cheri_default_mext_name} and {cheri_default_sext_name} for {cheri_mode_name}s for Privileged Architectures
...
:cheri_sv39_ext:           Svy39
:cheri_sv48_ext:           Svy48
:cheri_sv57_ext:           Svy57
:cheri_priv_vmem_ext: {cheri_sv39_ext}, {cheri_sv48_ext} and {cheri_sv57_ext} Supervisor-Level ISA for Virtual Memory ({cheri_base64_ext_name})
...
// 16-bit encodings added b RVY+C
...
// Extension for CHERI MMU-based revocation
//PTE bits
:rv64y_pte4_field_name:    pass:quotes[RVY]
:rv64y_pte4_field_name_lc: pass:quotes[rvy]

//combined load/store enable
:pte_cap_rw_name:          pass:quotes[Y]
:pte_cap_rw_name_lc:       pass:quotes[y]

//revocation extension
:pte_cap_r_name:           pass:quotes[YR]
:pte_cap_r_name_lc:        pass:quotes[yr]

:pte_cap_w_name:           pass:quotes[YW]
:pte_cap_w_name_lc:        pass:quotes[yw]

:pte_cap_dirty_name:       pass:quotes[YD]
:pte_cap_dirty_name_lc:    pass:quotes[yd]

:pte_cap_fc_name:          pass:quotes[RG]
:pte_cap_fc_name_lc:       pass:quotes[rg]

:pte_cap_crg_pte_name:     Y{pte_cap_fc_name}
:pte_cap_crg_pte_name_lc:  y{pte_cap_fc_name_lc}

:pte_cap_fc_enable:        {pte_cap_crg_pte_name}E
:pte_cap_fc_enable_lc:     {pte_cap_crg_pte_name}e

//extension name
:cheri_priv_crg_ext:       Svy{pte_cap_fc_name_lc}

// Extension for capability levels (flow control)
:cheri_levels1_ext_name:             Zylg

:cheri_seal_ext_name: Zyseal

:cheriot_unpriv_ext_name: Zycheriot
:cheriot_priv_ext_name: Smycheriot
...
:TAG_RESET_UCSR: The EEI sets the value of the {ctag} of this CSR to zero, and the values of the metadata and address fields are UNSPECIFIED.
:REQUIRE_HYBRID_CSR: This CSR is only implemented if {cheri_default_ext_name} is implemented.
:ROOT_RX_RESET_SCSR: When the S-mode execution environment starts, the maximum value is the <<root-rx-cap>> capability.


:CAP_MODE_VALUE: 0
:INT_MODE_VALUE: 1
:CAP_MODE_VALUE_WORD: zero
:INT_MODE_VALUE_WORD: one
...
:cap_cheriot_sdp_width:    1
:cap_cheriot_perms_width:  5
:cap_cheriot_exp_width:    4
:cap_cheriot_exp_range_max: 14
:cap_cheriot_exp_max:      24
:cap_cheriot_mw_width:     9
:cap_cheriot_addr_width:   32

// Base suffixes
:rv32y_uni_encoding_suffix: LYA
:rv64y_uni_encoding_suffix: LYA
:rv64y_uni_base_name: RV64{rv64y_uni_encoding_suffix}
:rv32y_uni_base_name: RV32{rv32y_uni_encoding_suffix}

:rvy_cheriot_common_base_suffix: LYmw{cap_cheriot_mw_width}e{cap_cheriot_exp_range_max}r0as11pc

:rv32y_cheriot_encoding1_name: RV32LYenccheriot1
:rv32y_cheriot_encoding2_name: RV32LYenccheriot2
:rv32y_cheriot_encoding3_name: RV32LYenccheriot3
...
:rvy_bndsrdw_insn_ext_name: Zybndsrdw
:rvy_bndsrdw_insn_file_name:     {rvy_bndsrdw_insn_ext_name}_insns_table_body
:SCBNDSRD:      YBNDSRDW
:SCBNDSRD_LC:   ybndsrdw
:SCBNDSRD_DESC: Write capability bounds, rounding down if required
...
:SCSS:         YSS
:SCSS_LC:      yss
:SCSS_DESC:    Capability is a subset
...
:sentry_caps_uc: Sealed entry point capabilities
