...
:cheri_default_sext_name:  Ssyhybrid
:cheri_default_mext_name:  Smyhybrid
:cheri_mode_name:          CHERI Pointer Mode
:cheri_priv_m_ext: Smy
:cheri_priv_hybrid_exts: {cheri_default_mext_name} and {cheri_default_sext_name}
...
:cheri_priv_vmem_ext: Sv39/Sv48/Sv57 ({cheri_base_ext_name})
