...
:rvy_uni_encoding_suffix: CEU
:rvy_uni_base_name:   {cheri_base_ext_name}_{rvy_uni_encoding_suffix}
:rvy64_uni_base_name: {cheri_base64_ext_name}_{rvy_uni_encoding_suffix}
:rvy64e_uni_base: {cheri_base64_ext_name}E_{rvy_uni_encoding_suffix}
:rvy32_uni_base_name: {cheri_base32_ext_name}_{rvy_uni_encoding_suffix}
:rvy32e_uni_base_name: {cheri_base32_ext_name}E_{rvy_uni_encoding_suffix}
