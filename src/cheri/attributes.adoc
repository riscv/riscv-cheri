...
:rvy_c_ext_name:           "C" Extension ({cheri_base_ext_name})
:rvy_c_file_name:          {cheri_base_ext_name}_C_insns_table_body
// 16-bit encodings modified by RVY+C
:rvy_c_mod_ext_name:       "C" Extensions ({cheri_base_ext_name} modified behavior)
:rvy_c_mod_file_name:      {cheri_base_ext_name}_C_mod_insns_table_body
