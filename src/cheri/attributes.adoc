...
:rvyi_ext_name:         {cheri_base_ext_name}I
// 32-bit encoding for YSENTRY
:rvyi_sentry_ext_name:  {cheri_base_ext_name}I_SENTRY
// 32-bit encodings modified by RVY
:rvyi_mod_ext_name:     {cheri_base_ext_name}I_MOD
// 16-bit encodings added by RVY+C
:rvyc_ext_name:         {cheri_base_ext_name}C
// 16-bit encodings modified by RVY+C
:rvyc_mod_ext_name:     {cheri_base_ext_name}C_MOD
// 32-bit encodings added by RVY+Zba
:rvyba_ext_name:        {cheri_base_ext_name}BA
// 32-bit encodings added by RVY+Zalrsc
:rvyalrsc_ext_name:     {cheri_base_ext_name}ALRSC
// 32-bit encodings added by RVY+Zaamo
:rvyaamo_ext_name:      {cheri_base_ext_name}AAMO
// 32-bit encodings added by RVY+A
:rvyh_ext_name:         {cheri_base_ext_name}H
// 32-bit encodings added by RVY+Zicbom
:rvycbom_ext_name:      {cheri_base_ext_name}CBOM
// 32-bit encodings added by RVY+Zicboz
:rvycboz_ext_name:      {cheri_base_ext_name}CBOZ
// 32-bit encodings added by RVY+Zicbop
:rvycbop_ext_name:      {cheri_base_ext_name}CBOP
// 32-bit encodings added by Zyhybrid
:rvyi_default_ext_name: {cheri_default_ext_name}I
...
//need the concept of a third mode for when misa.Y = 0
//to be added into the text after merging https://github.com/riscv/riscv-cheri/pull/730
:cheri_off_mode_name: pass:quotes[_RISC-V Mode_]
:cheri_int_mode_name: pass:quotes[_RISC-V Compatibility Mode_]
:cheri_cap_mode_name: pass:quotes[_CHERI Mode_]
