...
:rvyi_ext_name:         Zyi
:rvyi_file_name:        {rvyi_ext_name}_insns_table_body
:rvyi_xref:             <<{rvyi_file_name}, {rvyi_ext_name}>>
// 32-bit encoding for YSENTRY
:rvyi_sentry_ext_name:  Zys
:rvyi_sentry_file_name: {rvyi_sentry_ext_name}_insns_table_body
:rvyi_sentry_xref:      <<{rvyi_sentry_file_name}, {rvyi_sentry_ext_name}>>
// 32-bit encodings modified by RVY
:rvyi_mod_ext_name:     Zyi_mod
:rvyi_mod_file_name:    {rvyi_mod_ext_name}_insns_table_body
:rvyi_mod_xref:         <<{{rvyi_mod_file_name}, {rvyi_mod_ext_name}>>
// 16-bit encodings added by RVY+C
:rvyc_ext_name:         Zyc
:rvyc_file_name:        {rvyc_ext_name}_insns_table_body
:rvyc_xref:             <<{rvyc_file_name}, {rvyc_ext_name}>>
// 16-bit encodings modified by RVY+C
:rvyc_mod_ext_name:     Zyca_mod
:rvyc_mod_file_name:    {rvyc_mod_ext_name}_insns_table_body
:rvyc_mod_xref:         <<{rvyc_mod_file_name}, {rvyc_mod_ext_name}>>
// 32-bit encodings added by RVY+Zba
:rvyba_ext_name:        Zba ({cheri_base_ext_name})
:rvyba_file_name:       Zba_{cheri_base_ext_name}_insns_table_body
:rvyba_xref:            <<{rvyba_file_name}, {rvyba_ext_name}>>
// 32-bit encodings added by RVY+Zalrsc
:rvyalrsc_ext_name:     Zalrsc ({cheri_base_ext_name})
:rvyalrsc_file_name:    Zalrsc_{cheri_base_ext_name}_insns_table_body
:rvyalrsc_xref:         <<{rvyalrsc_file_name}, {rvyalrsc_ext_name}>>
// 32-bit encodings added by RVY+Zaamo
:rvyaamo_ext_name:      Zaamo ({cheri_base_ext_name})
:rvyaamo_file_name:     Zaamo_{cheri_base_ext_name}_insns_table_body
:rvyaamo_xref:          <<{rvyaamo_file_name}, {rvyaamo_ext_name}>>
// 32-bit encodings added by RVY+A
:rvyh_ext_name:         H ({cheri_base_ext_name})
:rvyh_file_name:        H_{cheri_base_ext_name}_insns_table_body
:rvyh_xref:             <<{rvyh_file_name}, {rvyh_ext_name}>>
// 32-bit encodings added by RVY+Zicbom
:rvycbom_ext_name:      Zicbom ({cheri_base_ext_name})
:rvycbom_file_name:     Zicbom_{cheri_base_ext_name}_insns_table_body
:rvycbom_xref:          <<{rvycbom_file_name}, {rvycbom_ext_name}>>
// 32-bit encodings added by RVY+Zicboz
:rvycboz_ext_name:      Zicboz ({cheri_base_ext_name})
:rvycboz_file_name:     Zicboz_{cheri_base_ext_name}_insns_table_body
:rvycboz_xref:          <<{rvycboz_file_name}, {rvycboz_ext_name}>>
// 32-bit encodings added by RVY+Zicbop
:rvycbop_ext_name:      Zicbop ({cheri_base_ext_name})
:rvycbop_file_name:     Zicbop_{cheri_base_ext_name}_insns_table_body
:rvycbop_xref:          <<{rvycbop_file_name}, {rvycbop_ext_name}>>
// 32-bit encodings added by Zyhybrid
:rvyi_default_ext_name:  {cheri_default_ext_name}
:rvyi_default_file_name: {cheri_default_ext_name}_insns_table_body
:rvyi_default_xref:      <<{rvyi_default_file_name}, {rvyi_default_ext_name}>>
...
:cheri_seal_amb_ext_name: Zysealambient
:cheri_sentry_ext_name: Zysentry
