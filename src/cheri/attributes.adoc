...
:rvy32_cheriot_base_name: {cheri_base32_ext_name}E{rvy_cheriot_encoding_suffix}
:rvy_cheriot2_encoding_suffix: _Lxymw9r0as11pc
:rvy32_cheriot2_base_name: {cheri_base32_ext_name}E{rvy_cheriot2_encoding_suffix}
