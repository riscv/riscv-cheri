...
:not_v1_ratification_package: pass:quotes[#This chapter is not part of the v1.0 ratification package.#]
...
:cheri_priv_crg_ext:          Svyrg
:cheri_priv_crg_ext_caps:     SVYRG
...
:revocation_name:          pass:quotes[RG]
:revocation_name_lc:       pass:quotes[rg]

:pte_cap_crg_pte_name:     Y{revocation_name}
:pte_cap_crg_pte_name_lc:  y{revocation_name_lc}

:revocation_enable:        {pte_cap_crg_pte_name}E
:revocation_enable_lc:     {pte_cap_crg_pte_name}e

:revocation_x:             x{pte_cap_crg_pte_name}
:revocation_x_lc:          x{pte_cap_crg_pte_name}

:revocation_u:             U{pte_cap_crg_pte_name}
:revocation_u_lc:          u{pte_cap_crg_pte_name}

:revocation_s:             S{pte_cap_crg_pte_name}
:revocation_s_lc:          s{pte_cap_crg_pte_name}
...
// Base suffixes
:rv32y_uni_encoding_suffix: _Lymw{cap_rv32_mw_width}rc1pc
:rv64y_uni_encoding_suffix: _Lymw{cap_rv64_mw_width}rc1ps
...
:rvy_cheriot_common_base_suffix: _Lymw{cap_cheriot_mw_width}e{cap_cheriot_exp_range_max}r0as11pc

:rv32y_cheriot_encoding1_name: RV32Y_Lyenccheriot1
:rv32y_cheriot_encoding2_name: RV32Y_Lyenccheriot2
:rv32y_cheriot_encoding3_name: RV32Y_Lyenccheriot3
