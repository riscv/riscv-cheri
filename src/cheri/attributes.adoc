...
// university (default) encoding scheme
// For some reason can't use _Lymw{cap_rv32_mw_width}e{cap_rv32_exp_max}rc1pc
// here, probably need some macro for double expansion
:rvy32_uni_encoding_suffix: _Lymw10e24rc1pc
:rvy64_uni_encoding_suffix: _Lymw14e52rc1ps
:rvy64_uni_base_name: {cheri_base64_ext_name}{rvy64_uni_encoding_suffix}
:rvy64e_uni_base: {cheri_base64_ext_name}E{rvy64_uni_encoding_suffix}
:rvy32_uni_base_name: {cheri_base32_ext_name}{rvy32_uni_encoding_suffix}
:rvy32e_uni_base_name: {cheri_base32_ext_name}E{rvy32_uni_encoding_suffix}
// cheriot encoding scheme
:rvy_cheriot_encoding_suffix: CEC
:rvy32e_cheriot_base_name: {cheri_base32_ext_name}E_{rvy_cheriot_encoding_suffix}
