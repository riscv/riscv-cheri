...
:cheri_off_mode_name: pass:quotes[_CHERI Disabled Mode_]
:cheri_int_mode_name: pass:quotes[_Non-CHERI Address Mode_]
:cheri_cap_mode_name: pass:quotes[_CHERI Capability Mode_]
