...
:cheri_base64_ext_name:    RV64CH
:cheri_base32_ext_name:    RV32CH
...
:cheri_default_cap: Zcheridefaultcap
...
:TAG_RESET_CSR: The validity tag of the CSR must be reset to zero. The reset values of the metadata and address fields are UNSPECIFIED.
