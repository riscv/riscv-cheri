...
<<section_rvy_sentry_jalr_ext>>:: Unprivileged extension for sealed function entry points (for CFI).
...
|<<section_rvy_sentry_jalr_ext>>                            | Stable        | This extension is a candidate for freezing
