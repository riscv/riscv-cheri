...
|<<rv64y,RV64Y>>                                            | Base ISA and capability format for RV64
ifndef::cheri_ratification_v1_only[]
|<<rv32y,RV32Y>>                                            | Base ISA and capability formats for RV32
endif::[]
...
|<<section_rvy_topr_insn_ext>>                              |  Extension for extracting the top bound
ifndef::cheri_ratification_v1_only[]
