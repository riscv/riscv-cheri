...
|=============================================================================================================================================================
| Extension or Specification                                | Description
|<<section_cheri_disable,{cheri_default_sext_name}>>, <<section_cheri_disable,{cheri_default_mext_name}>>,     | Privileged support for {cheri_default_ext_name}
ifdef::support_varxlen[]
|<<section_cheri_dyn_xlen,{cheri_priv_m_dyn_xlen_ext}>>     | Dynamic XLEN support
endif::support_varxlen[]
|<<section_priv_cheri_vmem,{cheri_sv57_ext}>>, <<section_priv_cheri_vmem,{cheri_sv48_ext}>>, <<section_priv_cheri_vmem,{cheri_sv39_ext}>>          | Virtual Memory support
