...
|<<{rvy_i_mod_file_name},     I>>      | RVY redefines the behavior of control flow and RVI loads/stores
|<<{rvy_zca_mod_file_name},   Zca>>    | Compressed control-flow, memory, and stack-pointer adjustment instructions operate on capabilities
|<<section_cheri_vector_integration, V>> | Vector memory access instructions require capability operands and check bounds
...
|<<{rvy_zicbop_mod_file_name}, Zicbop>> | Cache-block prefetch operations require capability operands and check bounds
...
ifdef::include_zabhlrsc[]
.Unprivileged stable extension used by CHERI software
[#zabhlrsc_unpriv-extension-status]
[options=header,align=center,width="90%"]
|=============================================================================================================================================================
| Extension or Specification                                | Description
