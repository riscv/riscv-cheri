...
|<<rv64y_cap_description,{rv64y_uni_base_name}>>            | 64-bit capability encoding
|<<rv32y_cap_description,{rv32y_uni_base_name}>>            | 32-bit capability encoding
|<<rv32y_cheriot_cap_description,{rvy32e_cheriot_base_name}>> | Alternate 32-bit capability encoding (CHERIoT)
