...
|111    |00    3+| {C_STORE_CAP_NAME}
|111    |10    3+| {C_STORE_CAP_SP_NAME}
|011    |10    3+| {C_LOAD_CAP_SP_NAME}
|011    |00    3+| {C_LOAD_CAP_NAME}

|101    |00      | N/A    | C.FSD    | reserved
|001    |00      | N/A    | C.FLD    | reserved
ifdef::cheri_ratification_v1_only[]
|101    |10      | N/A    | C.FSDSP  | reserved for Zcmp / Zcmt ({cheri_base32_ext_name})
endif::[]
