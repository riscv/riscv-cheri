...
NOTE: The approach of using indexed loads with the base register set to the value zero and XLEN-bit offsets does not work well with CHERI as the authorizing capability must cover all of memory.
