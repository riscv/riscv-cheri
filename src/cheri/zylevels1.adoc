...
| Zylevels1-1     | <<zylevels1_lg_perm>>  | <<c_perm>> and <<r_perm>>
| Zylevels1-2     | <<zylevels1_sl_perm>>  | <<c_perm>> and <<w_perm>>
|===

=== Interaction with <<LC>> and <<LR_C>>
