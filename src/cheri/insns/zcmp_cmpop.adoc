...
Load *c* registers as specified in _yreg_list_. Deallocate stack frame. All accesses are checked against `ysp`.

{cheri_int_mode_name} Description::
Load integer registers as specified in _xreg_list_. Deallocate stack frame. All accesses are checked against <<ddc>>.
