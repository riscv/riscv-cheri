...
+
NOTE: The loaded capability may be invalidated under platform-specified conditions, such as by a hardware-based use-after-free prevention scheme.
...
+
NOTE: Extensions may also specify additional conditions which invalidate the resulting capability.
+
