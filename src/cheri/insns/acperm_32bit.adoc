...
[NOTE]
====
Extensions like <<section_zylevels1,Zylevels1>> introduce bits that are, conceptually, _labels_ on a capability rather than a permission granted by the capability.
