...
NOTE: Any future extension that defines new permissions that are a refinement of existing permissions (e.g., finer-grained <<asr_perm>>
ifndef::cheri_ratification_v1_only[]
 or those of <<section_zylevels1>>
endif::[]
