...
. Encode the resulting architectural permissions,
  by iterating the rules in <<sec_permission_transitions>>
  as well as any rules added by extensions or the capability encoding, to fixed point.
+
