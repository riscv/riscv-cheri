...
.. If capability encoding format does not support the requested set of permissions then <<CLRPERM>> will return a minimal set of permissions, which may be no permissions.
