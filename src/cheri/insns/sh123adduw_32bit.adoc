...
[#SH1ADD_UW_CHERI,reftext="SH1ADD.UW ({cheri_base_ext_name})"]
==== SH1ADD.UW ({cheri_base_ext_name})
See <<SH3ADD_UW_CHERI>>.

[#SH2ADD_UW_CHERI,reftext="SH2ADD.UW ({cheri_base_ext_name})"]
==== SH2ADD.UW ({cheri_base_ext_name})
See <<SH3ADD_UW_CHERI>>.

[#SH3ADD_UW_CHERI,reftext="SH3ADD.UW ({cheri_base_ext_name})"]
==== SH3ADD.UW ({cheri_base_ext_name})
