...
and may, if viewed as a capability, not be derivable from the system's capability roots.
...
+
NOTE: Extensions may define further circumstances under which implicit <<CLRPERM>>-s or other mutation of loaded capabilities may take place.
+
