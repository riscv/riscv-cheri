...
NOTE: The <<section_cap_integrity,integrity>> check on `{cs2}` (included in the subset check) is required to prevent authorising a capability with a lack of integrity.
