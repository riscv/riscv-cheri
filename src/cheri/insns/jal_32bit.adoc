...
NOTE: A future extension may raise an exception on the branch instruction itself if a minimum sized instruction at the target <<pcc>> will raise a CHERI bounds exception.
