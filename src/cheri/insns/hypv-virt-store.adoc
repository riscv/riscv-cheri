...
the location indicated by the effective address and the validity tag bit of each block
...
effective address and the validity tag bit of each block of memory naturally aligned to
CLEN/8 is cleared.
