...
{reg: [
  ...
  {bits: 6, name: 'imm',    type: 3, attr: ['6','offset[5:4|9:6]']},
  {bits: 3, name: 'funct3', type: 8, attr: ['3', 'RV64Y: {C_STORE_CAP_SP_NAME}=101']},
], config: {bits: 16}}
....
...
{reg: [
  ...
  {bits: 3, name: 'imm',    types:3, attr: ['3', 'offset[5:4|8]']},
  {bits: 3, name: 'funct3', type: 8, attr: ['3', 'RV64Y: {C_STORE_CAP_NAME}=101']},
], config: {bits: 16}}
....
endif::[]
...
//need some text to make the next block render
