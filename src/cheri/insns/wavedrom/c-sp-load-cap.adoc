...
{reg: [
  {bits: 2, name: 'op',       type: 8, attr: ['2','C2=10']},
  {bits: 5, name: 'imm',      type: 5, attr: ['5','offset[4|9:6]']},
  {bits: 5, name: '{cd}≠0',type: 5, attr: ['5','dest']},
  {bits: 1, name: 'imm',      type: 1, attr: ['1','[5]',]},
  {bits: 3, name: 'funct3',   type: 3, attr: ['3', 'RV64Y: {C_LOAD_CAP_SP_NAME}=001']},
], config: {bits: 16}}
....
...
{reg: [
  ...
  {bits: 3, name: 'funct3',    type: 8, attr: ['3', 'RV64Y: {C_LOAD_CAP_NAME}=001']},
], config: {bits: 16}}
....
