...
* All writes to PMM in {cheri_cap_mode_name} set the field to 0.
...
NOTE: How to enable pointer masking in {cheri_cap_mode_name} is a research topic for a future extension.
==== Ssnpm
