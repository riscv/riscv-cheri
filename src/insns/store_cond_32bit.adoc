...
Prerequisites for Hybrid Mode SC.D::
RV64, and {cheri_hybrid_ext_name}, and A

Prerequisites for Capability Mode SC.W::
{cheri_base_ext_name}, and A

Prerequisites for Hybrid Mode SC.W::
{cheri_hybrid_ext_name}, and A

Prerequisites for Capability Mode SC.H, SC.B::
{cheri_base_ext_name}, and {lr_sc_bh_ext_name}

Prerequisites for Hybrid Mode SC.H, SC.B::
{cheri_hybrid_ext_name}, and {lr_sc_bh_ext_name}
