...
capabilities from integer values. The case `cs1 == 0` trivially leads to cd being
assigned the zero capability. This was chosen to be the case for clean architecture
design.
