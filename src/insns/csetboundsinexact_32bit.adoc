...
[#CSETBOUNDSINEXACT,reftext="CSETBOUNDSINEXACT"]
==== CSETBOUNDSINEXACT
...
Encoding::
include::wavedrom/csetboundsinexact_32bit.adoc[]
...
WARNING: TODO #this is the CSetBounds() function which will be renamed#
