...
Mnemonic for accessing XLEN-wide CSRs or extended CSRs in Hybrid Mode::
`csrrw rd, csr, rs1`
...
+
CSRRW writes `rs1` to extended CSRs in Hybrid Mode, and reads the address field into `rd`.
+
