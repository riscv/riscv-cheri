...
{cheri_cap_mode_name} Mnemonics (RV32CD/RV32D_Zca)::
`c.fsd fs2, offset(cs1'/csp)`

{cheri_cap_mode_name} Expansions (RV32)::
`fsd fs2, offset(csp)`

{cheri_int_mode_name} Mnemonics (RV32CD/RV32D_Zca)::
`c.fsd fs2, offset(rs1'/sp)`

{cheri_int_mode_name} Expansions (RV32)::
`fsd fs2, offset(rs1'/sp)`

{cheri_int_mode_name} Mnemonics (RV64CD/RV64D_Zca)::
`c.fsd fs2, offset(rs1'/sp)`

{cheri_int_mode_name} Expansion (RV64)::
`fsd fs2, offset(rs1'/sp)`
