...
NOTE: all mnemonics must be unique, but the intention is to always use `cadd/caddi`
 in the assembly syntax and distinguish `cadd/add` and `caddi/addi` by operand type.
