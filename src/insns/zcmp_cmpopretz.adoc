...
Permissions::
Loads are checked as for <<LC>> in both {cheri_int_mode_name} and {cheri_cap_mode_name}.
+
The return is checked as for <<JALR>> in both {cheri_int_mode_name} and {cheri_cap_mode_name}.
