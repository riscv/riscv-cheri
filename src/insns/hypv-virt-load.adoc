...
Prerequisites for pass:attributes,quotes[{cheri_cap_mode_name}] HLV.B[U], HLV.H[U], HLV.W::
{cheri_base_ext_name}, H

Prerequisites for pass:attributes,quotes[{cheri_int_mode_name}] HLV.B[U], HLV.H[U], HLV.W::
{cheri_base_ext_name}, {cheri_default_ext_name}, H

Prerequisites for pass:attributes,quotes[{cheri_cap_mode_name}] HLV.WU, HLV.D::
RV64, {cheri_base_ext_name}, H

Prerequisites for pass:attributes,quotes[{cheri_int_mode_name}] HLV.WU, HLV.D::
