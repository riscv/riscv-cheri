...
pass:attributes,quotes[pass:attributes,quotes[{cheri_cap_mode_name}]] Mnemonic::
`cm.jt _index_`

pass:attributes,quotes[pass:attributes,quotes[{cheri_int_mode_name}]] Mnemonics::
`cm.jt _index_`
...
pass:attributes,quotes[pass:attributes,quotes[{cheri_cap_mode_name}]] Description::
...
pass:attributes,quotes[pass:attributes,quotes[{cheri_int_mode_name}]] Description::
...
pass:attributes,quotes[pass:attributes,quotes[{cheri_cap_mode_name}]] Permissions::
Requires <<jvtc>> to be tagged, not sealed, have <<x_perm>> and for the full XLEN-wide access to be in <<jvtc>> bounds.

pass:attributes,quotes[pass:attributes,quotes[{cheri_cap_mode_name}]] Exceptions::
...
Prerequisites for pass:attributes,quotes[pass:attributes,quotes[{cheri_cap_mode_name}]]::
{c_cheri_base_ext_names}, Zcmt

Prerequisites for pass:attributes,quotes[pass:attributes,quotes[{cheri_int_mode_name}]]::
