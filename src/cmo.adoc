...
Each Zicbo* extension is replaced by an {cheri_base_ext_name} version:

* Zicbom is replaced by <<rvycbom_ext_name>>
* Zicboz is replaced by <<rvycboz_ext_name>>
* Zicbop is replaced by <<rvycbop_ext_name>>
