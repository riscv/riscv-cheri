...
The additional information is written for CHERI faults and <<cheri_pte_ext,CHERI PTE page faults>>.
...
NOTE: the use of <<mtval2>>/<<stval2>>/<<vstval2>> may be irregular as the Hypervisor uses
 <<mtval2>> and_htval_ for guest page addresses on guest page fault, and CHERI has no use for _htval_.
