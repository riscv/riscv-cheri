...
Additionally smaller datatype LR/SC encodings are available in the Zabhlrsc extension.
If {cheri_base_ext_name} and Zalrsc are implemented, then Zabhlrsc must also be implemented.
