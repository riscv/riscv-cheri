...
If the base architecture is {cheri_base_ext_name}, then an additional AMOSWAP encoding is available to access capability types in memory.
...
Therefore all atomic operations are _reserved_ if `cs1=c0`.
