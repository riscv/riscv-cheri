...
include::cheri/rvy64-encoding.adoc[]
include::cheri/rvy32-encoding.adoc[]
include::cheri/rvycheriot-encoding.adoc[]
include::cheri/rvycheriot2-encoding.adoc[]
include::cheri/rvycheriot3-encoding.adoc[]
ifndef::minimal_cheri_changes_doc[]
...
include::cheri/cheri-unpriv-appendix.adoc[]
