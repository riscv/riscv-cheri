[#section_priv_cheri]
== "{cheri_priv_m_ext}/{cheri_priv_s_ext}" Extensions for CHERI, Version 1.0
...
=== Machine-Level CSRs added by {cheri_priv_m_ext}
...
=== Supervisor-Level CSRs added by {cheri_priv_s_ext}
