...
{cheri_default_ext_name} defines the set of instructions added by the Default Mode, in addition to {cheri_base_ext_name}.

NOTE: {cheri_default_ext_name} implies {cheri_base_ext_name}

.{cheri_default_ext_name} instruction extension - Default Mode instructions
...
.Instructions valid for execution in Default Mode only
[#legacy_mode_insns]
[width="100%",options=header,cols="3,1,1,3"]
|==============================================================================
...
.Instructions valid for execution in both capability and Default Modes
[#both_mode_insns]
[width="100%",options=header,cols="3,1,1,3"]
|==============================================================================
...
.Mnemonics with the same encoding but mapped to different instructions in Default and Capability Mode
[#legacy_mnemonics]
...
NOTE: <<MODESW>> and <<SCMODE>> only exist in Capability Mode if Default Mode is _also_ present. A purecap core does not implement the mode bit in the capability.
