...
{cheri_legacy_ext_name} defines the set of instructions added by the Default Mode, in addition to {cheri_base_ext_name}.

NOTE: {cheri_legacy_ext_name} implies {cheri_base_ext_name}

.{cheri_legacy_ext_name} instruction extension - Default Mode instructions
