...
NOTE: <<MODESW>> and <<SCMODE>> only exist in {cheri_cap_mode_name} if {cheri_int_mode_name} is _also_ present. A purecap core does not implement the mode bit in the capability.
